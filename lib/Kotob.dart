...
class KotobScreen extends StatefulWidget {
  @override
  _KotobScreenState createState() => _KotobScreenState();
}

class _KotobScreenState extends State<KotobScreen> {
  @override
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
          ...
          AppBar(centerTitle: true,iconTheme: IconThemeData(color:  Color.fromRGBO(252,103 , 2, 1)),
            backgroundColor: Colors.white,
            leading: IconButton(onPressed: () {
              Navigator.pop(context);
            },
              icon: (Icon(Icons.arrow_back_ios,color: Color.fromRGBO(252,103 , 2, 1),)),),
            title: Text('كتب خفيفة',style: TextStyle(color: Colors.black,fontSize: 20),),
